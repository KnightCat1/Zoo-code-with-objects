...
public:
	Animal* loadAnimalBin(ifstream& in);
	void LoadName(ifstream& in, Animal*& a);
...
public:
	//friend Zoo& operator+=(Zoo& other, Animal& a);צריך להיות טמפליט
...
private:
	void DeepCopy(Animal* sorce, Animal*& dest);
	char*		m_name;
	char*		m_address;
	float		m_ticketPrice;
	char*		m_openHours;
